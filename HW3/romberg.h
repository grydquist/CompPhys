...
template <class T>
Doub qromb(T &func, Doub a, Doub b, const Doub eps=1.0e-10, Bool rep=true) {
	const Int JMAX=20, JMAXP=JMAX+1, K=2;
...
template<class T>
Doub qromo(Midpnt<T> &q, const Doub eps=3.0e-9, Bool rep=true) {
	const Int JMAX=24, JMAXP=JMAX+1, K=5;
